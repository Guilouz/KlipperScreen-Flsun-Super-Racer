...
class BedMeshPanel(ScreenPanel):
    ...
    def add_profile(self, profile):
        ...
        buttons = {
            "load": self._gtk.ButtonImage("load", _("Load"), "color2"), # Changes
        ...
        buttons["load"].connect("clicked", self.send_load_mesh, profile) # Changes
        ...
        if profile != "default":
            button_box.add(buttons["load"]) # Changes
